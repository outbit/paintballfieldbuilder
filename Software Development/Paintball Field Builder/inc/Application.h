...
#define WORLDUNITSPERMETER (WORLDUNITSPERYARD*1.0936133f)
#define WORLDUNITSPERFOOT (WORLDUNITSPERYARD/3)
#define WORLDUNITSPERINCH (WORLDUNITSPERFOOT/12)
#define SCALE 0.3f
...
#define MAX_BUNKERHEIGHT 5*SCALE
